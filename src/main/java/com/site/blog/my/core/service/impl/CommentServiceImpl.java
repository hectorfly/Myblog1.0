...
public class CommentServiceImpl implements CommentService {
    ...
    @Override
    public PageResult getCommentsPage(PageQueryUtil pageUtil, Integer userId) {
        pageUtil.setUserId(userId);
        List<BlogComment> comments = blogCommentMapper.findBlogCommentListByUserId(pageUtil);
        int total = blogCommentMapper.getTotalBlogComments(pageUtil);
        PageResult pageResult = new PageResult(comments, total, pageUtil.getLimit(), pageUtil.getPage());
        return pageResult;
    }
