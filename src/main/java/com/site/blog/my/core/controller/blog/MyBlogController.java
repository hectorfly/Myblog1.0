...
public class MyBlogController {
     ...
     * @return
     */
    @PostMapping({"/comments/showComment"})
    @ResponseBody
    public String showComment(HttpServletRequest request) {
        Object loginUserId1 = request.getSession().getAttribute("loginUserId");
        if(loginUserId1 != null){
            return "success";
        }
        return "fail";
    }
    ...
    public Result comment(HttpServletRequest request, HttpSession session,
        ...
        if(loginUserId1 != null){
            loginUserId = (int) loginUserId1;
        }
        if(loginUserId1 == null || loginUserId == 0){
